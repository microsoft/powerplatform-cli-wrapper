...
describe("pac", () => {
  describe("exportSolution", () => {
    ...
    beforeEach(() => {
      ...
      exportSolutionParameters = getMinMockExportSolutionParameters();
    });
    afterEach(() => restore());

    function rewireMock(exportSolutionParameters: ExportSolutionParameters, runnerParameters: RunnerParameters) : Promise<Promise<void>>
    {
    ...
    function getMinMockExportSolutionParameters() : ExportSolutionParameters
    {
      return {
    ...
    it("uses correct export parameters for simple pac solution export without optional parameters", 
      async () => 
      {
        await rewireMock(exportSolutionParameters, runnerParameters);
