...
import { ApplicationListParameters } from "src/actions/applicationList";
...
describe("action: list applications", () => {
  ...
  let applicationListParameters: ApplicationListParameters;
  ...
  async function runActionWithMocks(applicationListParameters: ApplicationListParameters) {
    const runnerParameters: RunnerParameters = createDefaultMockRunnerParameters();
    const mockedActionModule = await rewiremock.around(() => import("../../src/actions/applicationList"),
      (mock) => {
  ...
  const createApplicationListParameters = (): ApplicationListParameters => ({
